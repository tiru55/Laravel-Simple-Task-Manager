                ...
                <div class="px-4 py-5 bg-white sm:p-6">
                  <div class="grid grid-cols-6 gap-6">
                    <div class="col-span-6 sm:col-span-3">
                      ...
                      <input type="text" name="task_title" id="task_title" autocomplete="given-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="{{ $task->task_title }}">
                    </div>
                    ...
                    <div class="col-span-12 sm:col-span-6">
                      ...
                      <textarea  name="task_description" id="task_desctiption" required="" autocomplete="task_desctiption" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" rows="5">{{ $task->task_description }}</textarea>
                    </div>
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <input type="datetime-local" name="task_due_date" id="task_due_date" autocomplete="task_due_date" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="{{ $task->task_due_date}}"> 
                      </div>
